...
public class AuthService {
    ...
    public ResponseEntity<Response<TokenDTO>> login(LoginDTO account) {
        // Check username and password
        if (!account.getUsername().equals(username) || !account.getPassword().equals(password)) {
            Response<TokenDTO> response = new Response<>(ResponseStatus.ERROR, "Username or password is not correct");
        ...
        Response<TokenDTO> response = new Response<>(ResponseStatus.SUCCESS, "Login successfully", tokenDTO);
